                ...
                <Card>
                    <Card.Header className="border-0 align-items-center d-flex">
                        ...
                        <div className="d-flex gap-1">
                            ...
                            <button type="button" className="btn btn-soft-secondary btn-sm shadow-none" onClick={() => { onChangeChartPeriod("monthly"); }}>
                                1M
                            </button>
                            <button type="button" className="btn btn-soft-secondary btn-sm shadow-none" onClick={() => { onChangeChartPeriod("halfyearly"); }}>
                                6M
                            </button>
                            <button type="button" className="btn btn-soft-primary btn-sm shadow-none" onClick={() => { onChangeChartPeriod("yearly"); }}>
                                1Y
                            </button>
                        </div>
                    </Card.Header>
