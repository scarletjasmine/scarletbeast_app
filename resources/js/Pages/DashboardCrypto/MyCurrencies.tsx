                    ...
                    <Card.Header className="align-items-center d-flex">
                        ...
                        <div className="flex-shrink-0 ms-2">
                            <Dropdown className="card-header-dropdown" dir='start'>
                                <Dropdown.Toggle className="btn btn-soft-primary btn-sm arrow-none shadow-none" role="button" as="a">
                                ...
                                <tbody>
                                    {(currencies || []).map((item, key) => (
                                        <tr key={key}>
                                            ...
                                            <td><Link href="/apps-crypto-buy-sell" className="btn btn-sm btn-soft-secondary shadow-none">Trade</Link></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
