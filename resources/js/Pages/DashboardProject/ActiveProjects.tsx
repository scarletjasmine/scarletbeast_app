                ...
                <Card>
                    <Card.Header className="d-flex align-items-center">
                        ...
                        <div className="flex-shrink-0">
                            <Link href="#" className="btn btn-soft-info btn-sm shadow-none">Export Report</Link>
                        </div>
                    </Card.Header>
                    <Card.Body>
                        ...
                        <div className="align-items-center mt-xl-3 mt-4 justify-content-between d-flex">
                            ...
                            <ul className="pagination pagination-separated pagination-sm mb-0">
                                <li className="page-item disabled">
                                    <Button variant='link' className="page-link shadow-none">←</Button>
                                </li>
                                <li className="page-item">
                                    <Button variant='link' className="page-link shadow-none">1</Button>
                                </li>
                                <li className="page-item active">
                                    <Button variant='link' className="page-link shadow-none">2</Button>
                                </li>
                                <li className="page-item">
                                    <Button variant='link' className="page-link shadow-none">3</Button>
                                </li>
                                <li className="page-item">
                                    <Button variant='link' className="page-link shadow-none">→</Button>
                                </li>
