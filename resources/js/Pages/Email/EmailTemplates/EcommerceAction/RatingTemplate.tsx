                                                                ...
                                                                <thead>
                                                                    <tr style={{ textAlign: "left" }}>
                                                                        ...
                                                                        <th style={{ padding: "5px" }}>
                                                                            ...
                                                                            <Link href="#" itemProp="url" style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "11.36px", fontWeight: "normal", color: "#FFF", textDecoration: "none", textAlign: "center", cursor: "pointer", display: "inline-block", borderRadius: "4px", textTransform: "capitalize", backgroundColor: "#3bad71", margin: 0, borderColor: "#3bad71", borderStyle: "solid", borderWidth: "1px", padding: "4px 8px" }}
