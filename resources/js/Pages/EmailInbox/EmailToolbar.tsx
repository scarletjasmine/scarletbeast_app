            ...
            <div className="email-menu-sidebar">
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    <SimpleBar
                        ...
                        data-simplebar
                    >
                        <div className="mail-list mt-3" style={{cursor: "pointer"}}>
                            <a onClick={() => { toggleTab("all", "all", "all"); }} className={classnames({ active: activeTabs === 'all' })} >
                            ...
                            <a onClick={() => { toggleTab("inbox", "all", "all"); }} className={classnames({ active: activeTabs === 'inbox' })}>
                            ...
                            <div>
                                <a onClick={() => { toggleTab("sent", "all", "all"); }} className={activeTabs === "sent" ? "active" : ''}>
                            ...
                            <div>
                                <a onClick={() => { toggleTab("draft", "all", "all"); }} className={activeTabs === "draft" ? "active" : ''}>
                            ...
                            <div>
                                <a onClick={() => { toggleTab("spam", "all", "all"); }} className={activeTabs === "spam" ? "active" : ''}>
                            ...
                            <a onClick={() => { toggleTab("trash", "all", "all"); }} className={activeTabs === "trash" ? "active" : ''}>
                                <i className="ri-delete-bin-5-fill me-3 align-middle fw-medium"></i>
                                <span className="mail-list-link">
                                    Trash
                                </span>
                            </a>
                            <a onClick={() => { toggleTab("starred", "all", "all"); }} className={activeTabs === "starred" ? "active" : ''}>
                                <i className="ri-star-fill me-3 align-middle fw-medium"></i>
                                <span className="mail-list-link">
                                    Starred
                                </span>
                            </a>
                            <a onClick={() => { toggleTab("important", "all", "all"); }} className={activeTabs === "important" ? "active" : ''}>
                        ...
                        <div>
                            ...
                            <div className="mail-list mt-1">
                                <a onClick={() => { toggleTab("all", "all", "support"); }} className={isLabelTab === "support" ? "active" : ''}>
                                ...
                                <a onClick={() => { toggleTab("all", "all", "freelance"); }} className={isLabelTab === "freelance" ? "active" : ''}>
                                ...
                                <div>
                                    <a onClick={() => { toggleTab("all", "all", "social"); }} className={isLabelTab === "social" ? "active" : ''}>
                                ...
                                <a onClick={() => { toggleTab("all", "all", "friend"); }} className={isLabelTab === "friend" ? "active" : ''}>
                                ...
                                <a onClick={() => { toggleTab("all", "all", "family"); }} className={isLabelTab === "family" ? "active" : ''}>
