            ...
            <Col className="col-sm">
              <div className="d-md-flex justify-content-sm-end gap-2">
                <div className="search-box ms-md-2 flex-shrink-0 mb-3 mb-md-0">
                  <Form.Control type="text" id="searchJob" placeholder="Search for candidate name or designation..." autoComplete="off" onChange={(e: any) => handleSearch(e.target)} />
              ...
              <Modal.Body>
                ...
                <div className="mb-3">
                  ...
                  {validation.touched.candidateName && validation.errors.candidateName ? (
                    <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.candidateName}</Form.Control.Feedback>
                  ) : null}
                ...
                <div className="mb-3">
                  ...
                  {validation.touched.rating1 && validation.errors.rating1 ? (
                    <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.rating1}</Form.Control.Feedback>
                  ) : null}
                ...
                <div className="mb-3">
                  ...
                  {validation.touched.rating2 && validation.errors.rating2 ? (
                    <Form.Control.Feedback type="invalid" className='d-block'>{validation.errors.rating2}</Form.Control.Feedback>
                  ) : null}
