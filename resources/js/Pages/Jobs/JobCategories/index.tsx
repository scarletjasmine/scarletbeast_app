      ...
      <div className="page-content">
        <Container fluid className="container-fluid">
          ...
          <Row className="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {categoryList && (categoryList.categoryList || []).map((item: any, key: any) => (
              <Col key={key}>
                <Card>
            ...
            <Modal.Body>
              ...
              >
                <div className="mb-4">
                  ...
                  <Form.Control type="text" id="icon-input"
                ...
                <div className="mb-4">
                  ...
                  <Form.Control type="text" id="label-input"
                ...
                <div className="mb-4">
                  ...
                  <Form.Control type="text" id="position-input"
