          ...
          >
            <>
              ...
              >
                ...
                <li className="nav-item">
                  <NavLink href="#services" className="fs-14">Services</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink href="#features" className="fs-14">Features</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink href="#plans" className="fs-14">Plans</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink href="#reviews" className="fs-14">Reviews</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink href="#team" className="fs-14">Team</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink href="#contact" className="fs-14">Contact</NavLink>
                </li>
              </Scrollspy>
