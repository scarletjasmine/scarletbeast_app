                                            ...
                                            <Row className="g-2">
                                                <Col>
                                                    <div className="position-relative mb-3">
                                                        <Form.Control type="text" className="form-control-lg bg-light border-light" placeholder="Search here.." defaultValue="Admin Dashboard" />
                                                        <Link href="#" className="btn btn-link link-success btn-lg position-absolute end-0 top-0 shadow-none" onClick={toggleOffCanvas}><i className="ri-mic-fill"></i></Link>
                                                    </div>
                                                </Col>
