                            ...
                            <Row className="g-2">
                                <Col sm={4}>
                                    <div className="search-box">
                                        <Form.Control type="text" placeholder="Search for name or designation..." onChange={(e) => searchList(e.target.value)} />
                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        ...
                                        <Button variant="info" id="list-view-button" className="btn btn-soft-info nav-link  btn-icon fs-14 filter-button shadow-none"><i className="ri-list-unordered"></i></Button>
                                        <Dropdown
                                            show={dropdownOpen}
                                            onClick={toggledropDown}>
                                            <Dropdown.Toggle type="button" className="btn btn-soft-info btn-icon fs-14 arrow-none shadow-none">
                                        ...
                                        <Modal show={modal} onHide={toggle} centered>
                                            <Modal.Body>
                                                <Form onSubmit={(e) => {
                                                    ...
                                                    <Row>
                                                        <Col lg={12}>
                                                            <Form.Control type="hidden" id="memberid-input" defaultValue="" />
                                                            ...
                                                            <div className="mb-3">
                                                                <Form.Label htmlFor="teammembersName">Name</Form.Label>
                                                                <Form.Control type="text" id="teammembersName" placeholder="Enter name"
                                                                    name='name'
                                                        ...
                                                        <Col lg={6}>
                                                            <div className="mb-3">
                                                                <Form.Label htmlFor="projectCount">Projects</Form.Label>
