                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-shrink-0">
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <Dropdown dir='start'>
                                                            <Dropdown.Toggle as="button" className="btn btn-link shadow-none text-muted p-1 mt-n2 py-0 text-decoration-none fs-15 arrow-none">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        <div className="d-flex gap-1 align-items-center my-n2">
                                                            ...
                                                            <Dropdown dir='start'>
                                                                <Dropdown.Toggle as="button" className="btn btn-link text-muted shadow-none p-1 mt-n2 py-0 text-decoration-none fs-15 arrow-none">
                                                                    <FeatherIcon icon="more-horizontal" className="icon-sm" />
                                                                </Dropdown.Toggle>
