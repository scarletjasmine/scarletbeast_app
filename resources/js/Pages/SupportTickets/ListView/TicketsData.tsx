...
const TicketsData = () => {
    ...
    const columns = useMemo(
        () => [
            {
                header: <Form.Check.Input type="checkbox" id="checkBoxAll" onClick={() => checkedAll()} />,
                cell: (cellProps: any) => {
                    return <Form.Check.Input type="checkbox" className="ticketCheckBox" value={cellProps.getValue()} onChange={() => deleteCheckbox()} />;
                },
                id: '#',
            },
            {
