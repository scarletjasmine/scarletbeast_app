                                            ...
                                            <table className="table align-middle table-nowrap table-striped-columns mb-0">
                                                    ...
                                                    <tr>
                                                        <th scope="col" style={{ width: "46px" }}>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" value="" id="cardtableCheck" />
                                                                <Form.Check.Label htmlFor="cardtableCheck"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <th scope="col">ID</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" value="" id="cardtableCheck01" />
                                                                <Form.Check.Label htmlFor="cardtableCheck01"></Form.Check.Label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" value="" id="cardtableCheck02" />
                                                                <Form.Check.Label htmlFor="cardtableCheck02"></Form.Check.Label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" value="" id="cardtableCheck03" />
                                                                <Form.Check.Label htmlFor="cardtableCheck03"></Form.Check.Label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" value="" id="cardtableCheck04" />
                                                                <Form.Check.Label htmlFor="cardtableCheck04"></Form.Check.Label>
                                                            </div>
                                                        </td>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <Card.Body>
                                    <p className="text-muted">Use <code>table-dark</code> className to set dark color table body and <code>table-success</code> class to set success color table body respectively.
                                                    ...
                                                    <Table className="table-hover align-middle table-nowrap mb-0">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" style={{ "width": "25px" }}>
                                                                    <div className="form-check">
                                                                        <Form.Check.Input type="checkbox" id="checkAll" defaultValue="option1" />
                                                                    </div>
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="form-check">
                                                                        <Form.Check.Input type="checkbox" id="inlineCheckbox2" value="option1" defaultChecked />
                                                                    </div>
                                                                </th>
                                                                <td>#541254265</td>
                                                                <td>Amezon</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="form-check">
                                                                        <Form.Check.Input type="checkbox" id="inlineCheckbox3" defaultValue="option1" defaultChecked />
                                                                    </div>
                                                                </th>
                                                                <td>#744145235</td>
                                                                <td>Shoppers</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="form-check">
                                                                        <Form.Check.Input type="checkbox" id="inlineCheckbox4" defaultValue="option1" />
                                                                    </div>
                                                                </th>
                                                                <td>#9855126598</td>
                                                                <td>Flipkart</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="form-check">
                                                                        <Form.Check.Input type="checkbox" id="inlineCheckbox5" defaultValue="option1" />
                                                                    </div>
                                                                </th>
                                                                <td>#847512653</td>
                                                                <td>Shoppers</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div className="form-check form-switch">
                                                                        <Form.Check.Input type="checkbox" role="switch" id="SwitchCheck1" defaultChecked />
                                                                        <Form.Check.Label className="ms-2" htmlFor="SwitchCheck1">Yes/No</Form.Check.Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div className="form-check form-switch">
                                                                        <Form.Check.Input type="checkbox" role="switch" id="SwitchCheck2" />
                                                                        <Form.Check.Label className="ms-2" htmlFor="SwitchCheck2">Yes/No</Form.Check.Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div className="form-check form-switch">
                                                                        <Form.Check.Input type="checkbox" role="switch" id="SwitchCheck3" />
                                                                        <Form.Check.Label className="ms-2" htmlFor="SwitchCheck3">Yes/No</Form.Check.Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div className="form-check form-switch">
                                                                        <Form.Check.Input type="checkbox" role="switch" id="SwitchCheck4" defaultChecked />
                                                                        <Form.Check.Label className="ms-2" htmlFor="SwitchCheck4">Yes/No</Form.Check.Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <Table className="align-middle table-nowrap mb-0">
                                                <thead className="table-light">
                                                    <tr>
                                                        <th scope="col" style={{ "width": "46px" }}>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="cardtableCheck" />
                                                                <Form.Check.Label htmlFor="cardtableCheck"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <th scope="col">ID</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="cardtableCheck01" />
                                                                <Form.Check.Label htmlFor="cardtableCheck01"></Form.Check.Label>
                                                            </div>
                                                        </td>
                                                        <td><Link href="#" className="fw-medium">#VL2110</Link></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="cardtableCheck02" />
                                                                <Form.Check.Label htmlFor="cardtableCheck02"></Form.Check.Label>
                                                            </div>
                                                        </td>
                                                        <td><Link href="#" className="fw-medium">#VL2109</Link></td>
                                            ...
                                            <Table className="align-middle table-nowrap mb-0">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" style={{ "width": "42px" }}>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="activetableCheck" />
                                                                <Form.Check.Label htmlFor="activetableCheck"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <th scope="col">Order ID</th>
                                                        <th scope="col">Shop</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="activetableCheck01" defaultChecked />
                                                                <Form.Check.Label htmlFor="activetableCheck01"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <td>#541254265</td>
                                                        <td>Amezon</td>
                                                    ...
                                                    <tr className="table-active">
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="activetableCheck02" defaultChecked />
                                                                <Form.Check.Label htmlFor="activetableCheck02"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <td>#744145235</td>
                                                        <td>Shoppers</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="activetableCheck03" />
                                                                <Form.Check.Label htmlFor="activetableCheck03"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <td>#9855126598</td>
                                                        <td>Flipkart</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="activetableCheck04" />
                                                                <Form.Check.Label htmlFor="activetableCheck04"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <td>#847512653</td>
                                                        <td>Shoppers</td>
                                            ...
                                            <Table className="align-middle table-nowrap mb-0">
                                                <thead className="table-light">
                                                    <tr>
                                                        <th scope="col" style={{ "width": "42px" }}>
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                        <th scope="col">ID</th>
                                                        <th scope="col">Date</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck01" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck01"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck02" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck02"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck03" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck03"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck04" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck04"></Form.Check.Label>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div className="form-check">
                                                                <Form.Check.Input type="checkbox" defaultValue="" id="responsivetableCheck05" />
                                                                <Form.Check.Label htmlFor="responsivetableCheck05"></Form.Check.Label>
                                                            </div>
                                                        </th>
