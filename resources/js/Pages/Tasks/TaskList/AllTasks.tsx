      ...
      >
        ...
        <Form className="tablelist-form" onSubmit={(e: any) => {
          ...
          <Modal.Body className="modal-body">
            <Row className="g-3">
              <Col lg={12}>
                <Form.Label htmlFor="taskId-field">Order Id</Form.Label>
                <Form.Control
                  name="taskId"
                  id="taskId-field"
              ...
              <Col lg={12}>
                <Form.Label htmlFor="projectName-field">Project Name</Form.Label>
                <Form.Control
                  name="project"
              ...
              <Col lg={12}>
                <div>
                  <Form.Label htmlFor="tasksTitle-field">Title</Form.Label>
                  <Form.Control
                    name="task"
                    id="tasksTitle-field"
                    className="form-control"
                  ...
                  <ul className="list-unstyled vstack gap-2 mb-0">
                    {Assigned.map((item, key) => (<li key={key}>
                      <div className="form-check d-flex align-items-center">
                        <Form.Check.Input name="subItem" className="me-3" type="checkbox"
                          onChange={validation.handleChange}
                          onBlur={validation.handleBlur}
                          value={item.img}
                          id={item.imgId} />
              ...
              <Col lg={6}>
                <Form.Label htmlFor="duedate-field">Due Date</Form.Label>
                <Flatpickr
                  name="dueDate"
                  id="duedate-field"
                  className="form-control"
              ...
              <Col lg={6}>
                <Form.Label htmlFor="ticket-status">Status</Form.Label>
                <select
                  name="status"
              ...
              <Col lg={12}>
                <Form.Label htmlFor="priority-field">Priority</Form.Label>
                <select
                  name="priority"
                  className="form-select"
                  id="priority-field"
